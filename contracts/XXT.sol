...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  mapping (uint8 => RateData) private _rateTable;
  ...
  function _initRateTable() internal {
      ...
      _rateTable[3] = RateData(55 * 10 ** uint256(_decimals), 10000000 * 10 ** uint256(_decimals), 4);
      _rateTable[4] = RateData(34 * 10 ** uint256(_decimals), 20000000 * 10 ** uint256(_decimals), 5);
      _rateTable[5] = RateData(21 * 10 ** uint256(_decimals), 30000000 * 10 ** uint256(_decimals), 6);
      _rateTable[6] = RateData(13 * 10 ** uint256(_decimals), 40000000 * 10 ** uint256(_decimals), 7);
      _rateTable[7] = RateData(8 * 10 ** uint256(_decimals), 50000000 * 10 ** uint256(_decimals), 8);
      _rateTable[8] = RateData(5 * 10 ** uint256(_decimals), 60000000 * 10 ** uint256(_decimals), 9);
      _rateTable[9] = RateData(3 * 10 ** uint256(_decimals), 70000000 * 10 ** uint256(_decimals), 10);
      _rateTable[10] = RateData(2 * 10 ** uint256(_decimals), 80000000 * 10 ** uint256(_decimals), 11);
      _rateTable[11] = RateData(1 * 10 ** uint256(_decimals), 90000000 * 10 ** uint256(_decimals), 12);
      _rateTable[12] = RateData(1 * 10 ** uint256(_decimals), 100000000 * 10 ** uint256(_decimals), 13);
      _rateTable[13] = RateData(1 * 10 ** uint256(_decimals - 1), 100000000 * 10 ** uint256(_decimals), 14);
